...
# ============================================================
#   Baseline Text SFT Training
#   Purpose: Train with pure text input (no structure embedding)
# ============================================================
...
python src/main.py train-sft --config configs/training.yaml --mode text
